...
public class Boid {
	...
	private DustOptions color1;
	private DustOptions color2;
	...
	public Boid(Player player, FireSpray fireSpray, Location loc, Vector dir, double damage, double range) {
		...
		this.color1 = new DustOptions(Color.fromRGB(47, 135, 252), 1);
		this.color2 = new DustOptions(Color.fromRGB(182, 249, 255), 1);
	}
